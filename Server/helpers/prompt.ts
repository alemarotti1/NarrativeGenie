...
export const lugarPrompt = (prompt: string) => {
  let result = `preencha o json com os dados de um lugar descrito por "${prompt.trim()}". onde "descricao" tem a história do lugar, cultura, características físicas e pontos importantes e "descricao_fisica_em_ingles" tem a lista em inglês das características físicas e geográficas mais importantes do lugar. Garanta que "descricao" tenha ao menos 500 caracteres. `;
